...
public class RoutesRequestModel implements Serializable {
    ...
    public RoutesRequestModel(final String pLoginAdmin, final String pPassword, final String pLogin, final String user_name, final String user_date) {
        name_form = Constants.NameForm.ROUTES;
