...
public class PageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int type) {
        ...
        switch (type) {
            case 1:
                View view1 = LayoutInflater.from(viewGroup.getContext()).inflate(isAvia ? R.layout.element_select_avia : R.layout.element_select_auto, viewGroup, false);
    ...
    public class PageSelectViewHolder extends RecyclerView.ViewHolder {
        ...
        public void showSelectDialog(final ElementItemR item, final List<AnswerState> answerStates) {
            ...
            View layoutView = mActivity.getLayoutInflater().inflate(isAvia? R.layout.dialog_select_avia : R.layout.dialog_select_auto, null);
            ...
            SelectAdapter selectAdapter = new SelectAdapter(selectItems, item.getElementOptionsR().isPolyanswer(), isAvia, null);
