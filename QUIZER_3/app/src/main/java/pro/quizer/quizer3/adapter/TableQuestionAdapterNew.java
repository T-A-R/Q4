...
public class TableQuestionAdapterNew extends LinkedAdaptiveTableAdapter<ViewHolderImpl> implements OnItemClickListener {
    ...
    public TableQuestionAdapterNew(final ElementItemR pCurrentElement, List<ElementItemR> questions, final Context context, final Runnable pRefreshRunnable, OnTableAnswerClickListener pOnTableAnswerClickListener) {
