...
//                            Gson gsonConf = new Gson();
//                            String jsonConf = gsonConf.toJson(configResponseModel.getConfig().getProjectInfo().getElements());
//                            Log.d("T-L.SmartFragment", "?????? reloadConfig: " + jsonConf);
