                ...
                .enqueue(new Callback() {
                             ...
                             public void onResponse(@NonNull final Call call, @NonNull final Response response) throws IOException {
                                 ...
                                 responseJson = "{\n" +
                                         ...
                                         "      \"media_files\": [\n" +
                                         "        \"http://quizer-dev.quizer.pro/sound.mp3\",\n" +
                                         "        \"http://quizer-dev.quizer.pro/photo.jpg\",\n" +
                                         "        \"http://quizer-dev.quizer.pro/video.mp4\"\n" +
                                         "      ],\n" +
                                         "      \"name\": \"Экзит пул\",\n" +
                                         ...
                                         "          \"options\": {\n" +
                                         "            \"type\": \"list\",\n" +
                                         "            \"show_condition\": \"if ( ( ($e.2.checked || $e.3.checked) && ($e.5.checked || $e.6.checked) ) && ($e.4.checked) ) {jump:57} else if ( ($e.2.checked || $e.3.checked || $e.4.checked || $e.5.checked) && $e.6.checked) {show} else {show}\",\n" +
                                         "            \"title\": \"Вопрос номер ДВА, вы ранее выбирали: <# $e.2.value #>, <# $e.3.title #>, <# $e.4.title #>, <# $e.5.title #>\",\n" +
                                         ...
                                         "              \"type\": \"answer\",\n" +
                                         "              \"options\": {\n" +
                                         "                \"show_condition\":\"if ( $e.2.checked ) {show} else {hide}\",\n" +
                                         "                \"title\": \"[8] Ответ вопроса 2 - 1, ранее было: <# $e.2.value #>, <# $e.3.title #>, <# $e.4.title #>, <# $e.5.title #>\",\n" +
                                         "                \"order\": 1,\n" +
                                         "                \"jump\": 57,\n" +
                                         "                \"open_type\": \"text\",\n" +
                                         "                \"placeholder\": \"Впишите\"\n" +
                                         ...
                                         "              \"type\": \"answer\",\n" +
                                         "              \"options\": {\n" +
                                         "                \"show_condition\":\"if ( $e.2.checked ) {hide} else {show}\",\n" +
                                         "                \"title\": \"[9] Ответ вопроса 2 - 2\",\n" +
                                         "                \"order\": 2,\n" +
                                         "                \"jump\": 57\n" +
                                         "              }\n" +
                                         "            },\n" +
                                         ...
                                         "              \"type\": \"answer\",\n" +
                                         "              \"options\": {\n" +
                                         "                \"show_condition\":\"if ( $e.3.checked ) {show} else {hide}\",\n" +
                                         "                \"title\": \"[10] Ответ вопроса 2 - 3\",\n" +
                                         "                \"order\": 3,\n" +
                                         "                \"jump\": 57\n" +
                                         "              }\n" +
                                         "            }\n" +
                                         ...
                                         "              \"type\": \"question\",\n" +
                                         "              \"options\": {\n" +
                                         "                \"show_condition\":\"if ( ( ($e.2.checked || $e.3.checked) && ($e.5.checked || $e.6.checked) ) && ($e.4.checked) ) {hide} else if ( ($e.2.checked || $e.3.checked || $e.4.checked || $e.5.checked) && $e.6.checked) {show} else {show}\",\n" +
                                         "                \"type\": \"list\",\n" +
